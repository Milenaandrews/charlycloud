...
const Encabezado = () => {
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 content-center gap-5 h-screen mx-0 px-0 w-screen xl:px-70 sm:px-20 bg-cover bg-center' style= {{ backgroundImage: `url(https://res.cloudinary.com/dzppqa6a9/image/upload/v1713405556/nubes_charly_cloud_nawowy.png)`}}>
