...
const Encabezado = () => {
    ...
    return (
        <>
            <div className="video-brackground relative h-full md:overflow-hidden md:h-screen ">
                ...
                <motion.div ref={ref} className='relative z-1 flex flex-col wrap  gap-5 h-auto w-auto min-w-full md:min-h-full pt-8 px-10 md:py-7  xl:px-70  justify-center ' >
