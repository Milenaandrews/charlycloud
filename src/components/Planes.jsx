...
const Planes = () => {
  return (
    <section id='planes' className='h-full w-full flex flex-col py-10  bg-charly1 bg-cover'>
      ...
      <h1 className='text-white font-bold text-[50px] text-center pb-16 px-5 '> ELIGE TU PLAN </h1>
      ...
      <div className="flex flex-col text-charly3 items-center pt-14 font-semibold text-center gap-5 px-3">
